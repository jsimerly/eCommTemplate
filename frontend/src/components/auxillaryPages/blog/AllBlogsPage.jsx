...
const MainBlog = ({title, img})  => (
  <div className='w-full rounded-md sm:p-10 sm:mx-20'>
    ...
    <div className='absolute top-[10%] w-1/2 left-[10%] sm:flex flex-col justify-center items-center bg-white rounded-md p-3 hidden'>
      <h2 className={`text-neutralDark sm:text-[40px] text-center font-bold p-6`}> {title}</h2>
    ...
    <h2 className={`text-neutralDark sm:text-[40px] text-center font-bold p-6 rounded-b-md bg-white`}> {title}</h2>
  </div>
)
const AllBlogsPage = () => {
  window.scrollTo(0,0)
  return (
    <div className='w-full flex flex-col justify-center items-center p-3 sm:p-10'>
      <h1 className='sm:py-10 text-[40px] text-neutralDark'> Blue Elf's Blogs</h1>
      <MainBlog
      ...
      <div className='flex flex-row p-2 my-6 text-neutralDark'>
