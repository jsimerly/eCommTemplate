...
const Hero = () => {
  return (
    <div className='w-full min-h-[400px] flex justify-center items-center p-5 sm:py-20 bg-primaryLight'>
      <div className={`${styles.boxWidth} flex justify-center items-center flex-wrap sm:flex-nowrap`}>
        ...
        > 
          ...
          <div className="text-[14px] sm:text-[20px] font-nobold mb-5 leading-relaxed">
            Rent products to be dropped off and picked up on your next vacation. Need a hammock, canopy, and surfboard for your getaway? We've got you covered.
          </div>
