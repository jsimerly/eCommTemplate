...
const QualityHeroV2 = () => {
  return (
    <div className="flex justify-center items center">
        <div className="text-tertiary sm:min-w-[1280px]">
            <div className="flex justify-center items-center bg-white sm:rounded-tl-md relative">
            <div className="flex justify-center items-center flex-col sm:w-[600px] p-10">
                    <h1 className="text-[28px] sm:text-[40px] text-center font-bold"> <span className="text-primary"> 100% </span>Quality Guarantee</h1>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 justify-center items-center px-6 p-2 sm:p-10 bg-tertiary">
                {topRightLogos.map((logo, index) => (
                    <div key={index} className="p-4 sm:p-10 sm:h-[160px] flex justify-center items-center">
                        <img src={logo} className='max-h-[80px]' key={index}/>
                    </div>
                ))}
            </div>
            <div className="grid grid-cols-2 sm:grid-cols-4 justify-center items-center sm:rounded-b-md px-6 py-2 sm:p-10 bg-tertiary">
