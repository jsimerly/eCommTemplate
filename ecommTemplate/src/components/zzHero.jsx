  ...
  return (
    <div className='w-full min-h-[400px] flex justify-center items-center sm:py-20 bg-primaryLight'>
      <div className={`${styles.boxWidth} flex justify-center items-center flex-wrap sm:flex-nowrap`}>
        <div
          className='flex mx-3 sm:mx-10 text-tertiary sm:min-w-[400px] flex-col'
        > 
          <div className="font-semibold text-[26px] sm:text-[38px] mb-3 flex justify-center sm:justify-start text-primary">
