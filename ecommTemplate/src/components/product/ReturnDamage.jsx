...
const damagesReturns = {
  damages: [
    ...
    "Damages or loss should be reported immediately to Blue Elf by contacting us at [phone number or email address]."
  ],
  returns: [
    'The rented item must be ready for pick up or returned to Blue Elf by the agreed-upon return date and time.',
    'Failure to return the rented item on time will result in a late fee of [insert late fee amount]',
    "If the rented item is not returned within 48 hours of the agreed-upon return date and time, Blue Elf will consider the item lost and charge the renter's credit card on file the full retail value of the item.",
    "If the renter needs to extend the rental period, they must contact Blue Elf at least 24 hours prior to the agreed-upon return date and time to make arrangements. Out of fairness to other rents who may be using the item after you, there is no guarantee on rental extensions.",
...
const ReturnDamage = ({context}) => {
  return (
    <div className="bg-tertiaryTone-100 p-10 mx-1 flex flex-col justify-center items-center">
      <h1>We understand that accidents can happen during the rental period. To ensure a fair and consistent policy, we have outlined the following rental damages and returns policy.
      </h1>
      ...
      <p>
        By renting from Blue Elf, you agree to the terms of this rental damages and returns policy. If you have any questions or concerns, please contact us at [phone number or email address].
        </p>
    </div>
  )
}
