  ...
  return (
    <div className='flex-1 justify-start items-center max-w-3xl'>
        <div className='flex-1 sm:flex'>
            <label className="relative text-tertiaryTone-200 focus-within:text-tertiary flex items-center flex-1">
                <svg 
                className="pointer-events-none w-8 h-8 absolute transform "
                ...
                <input className='shadow focus:shadow-outline focus:outline-none flex-1 p-2 mr-1 rounded-md placeholder-tertiaryTone-200 text-tertiary pl-10' placeholder='Going to' type='text'/>
            </label>
            
            <label className="relative text-tertiaryTone-200 focus-within:text-tertiary flex items-center">
                <svg 
                ...
                <input className='rounded-md mr-1 max-w-[140px] shadow focus-shadow-outline focus:outline-none placeholder-tertiaryTone-200 text-tertiary pl-10 p-2' placeholder="From"/>
            </label>
            ...
            <label className="relative text-tertiaryTone-200 focus-within:text-tertiary flex items-center">
                ...
                <input className='rounded-md mr-1 max-w-[140px] shadow focus-shadow-outline focus:outline-none placeholder-tertiaryTone-200 text-tertiary pl-10 p-2' placeholder="to"/>
