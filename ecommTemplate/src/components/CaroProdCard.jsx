...
const CaroProdCard = (props) => {
  return (
    <div className='w-[150px] h-[260px] sm:h-[460px] sm:w-[300px] rounded-md bg-tertiaryTone-100 p-2 sm:pt-4 sm:px-4 flex flex-col mr-4'>
        ...
        <div className='flex flex-col flex-1 w-full justify-between items-start sm:my-4'>
          <div className='flex justify-between w-full items-center mt-3'>
            <div className='font-semibold sm:text-[26px]'>
              ...
              <div className='text-white bg-primary rounded-md'>
                <AddIcon/>
              </div>
          </div>
        </div>
